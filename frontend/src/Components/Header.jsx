...
const Header = () => {
    ...
    return (
        <header className="w-full h-[60px] bg-teal-600 flex relative items-center justify-between gap-2 px-4 shadow-lg">
            <div className="hidden">
                <ScreenLoader />
            </div>
            <Link
                className="logo flex items-center text-black text-opacity-40 hover:text-opacity-90 max-h-[60px]"
                to="/dashboard"
            >
                <iconify-icon icon="system-uicons:document-stack" width={34} height={34} />
                <h3 className="cursor-pointer text-2xl p-2 font-semibold font-abel">Medic Log</h3>
            </Link>
            <div className="actions max-h-[60px] flex items-center">
